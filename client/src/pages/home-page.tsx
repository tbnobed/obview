            ...
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div className="h-10 w-10 rounded-full bg-primary-50 dark:bg-white/10 flex items-center justify-center">
                  <svg className="h-5 w-5 text-primary-500 dark:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                  </svg>
                </div>
                <div>
                  <div className="font-medium dark:text-white">All Projects</div>
                  <div className="text-xs text-neutral-500 dark:text-gray-300">View and manage projects</div>
                </div>
              </Button>
              ...
              {user?.role === "admin" && (
                ...
                >
                  ...
                  <div>
                    <div className="font-medium dark:text-white">Admin Panel</div>
                    <div className="text-xs text-neutral-500 dark:text-gray-300">Manage users and settings</div>
                  </div>
                </Button>
              )}
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="bg-primary-50 dark:bg-[#026d55]/20 text-primary-600 dark:text-[#026d55] rounded-full h-6 w-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                  1
                </div>
                <div>
                  <h3 className="font-medium text-neutral-900 dark:text-white">Create a project</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-neutral-900 dark:text-white">Upload media</h3>
                  <p className="text-sm text-neutral-500 dark:text-gray-400">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-neutral-900 dark:text-white">Invite team members</h3>
                  <p className="text-sm text-neutral-500 dark:text-gray-400">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-neutral-900 dark:text-white">Review and approve</h3>
                  <p className="text-sm text-neutral-500 dark:text-gray-400">
