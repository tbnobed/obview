...
import { Loader2, FileVideo, Edit, Users, Plus } from "lucide-react";
      ...
      <main className="flex-1 overflow-y-auto bg-neutral-100 p-4 sm:p-6 lg:p-8">
        ...
        {activeTab === "comments" && (
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <h2 className="text-lg font-medium mb-4">All Comments</h2>
            <p className="text-neutral-500">
              This tab will show all comments across media files in this project.
            </p>
            {/* Comments listing component would go here */}
          </div>
        )}
        ...
        {activeTab === "activity" && (
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            ...
            <p className="text-neutral-500">
              This tab will show all activity in this project.
            </p>
