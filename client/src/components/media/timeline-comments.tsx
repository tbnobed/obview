...
export default function TimelineComments({ 
  ...
  return (
    <div className="h-full min-h-0 flex flex-col" style={{backgroundColor: 'hsl(var(--comments-bg))'}}>
      ...
      <div className="hidden lg:flex lg:flex-shrink-0 border-t px-3 pt-2 pb-[calc(env(safe-area-inset-bottom,0px)+8px)] bg-[hsl(var(--comments-bg))]/95 backdrop-blur supports-[backdrop-filter]:bg-[hsl(var(--comments-bg))]/80" style={{borderColor: 'hsl(var(--comments-card-border))'}}>
        <CommentForm
          fileId={fileId}
          currentTime={currentTime}
        />
