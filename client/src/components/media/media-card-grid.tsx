...
function MediaCard({
  ...
  return (
    <Card 
      ref={cardRef}
      className={cn(
        "group relative cursor-pointer transition-all duration-200 hover:scale-[1.02] rounded-2xl bg-card border-border dark:bg-zinc-900/70 dark:hover:bg-zinc-900 dark:border-transparent active:opacity-70",
