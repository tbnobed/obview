...
export default function MediaPlayer({
  ...
  // Format time in SMPTE format (HH:MM:SS;FF)
  const formatTime = (time: number) => {
    ...
    const frames = Math.floor((time % 1) * 24); // Assuming 24fps
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full min-h-0">
      ...
      {file && (
        <div className="w-full lg:w-80 border border-neutral-200 dark:border-gray-800 rounded-lg h-full min-h-0 flex flex-col dark:bg-[#0f1218]">
