                ...
                {file && (
                  <>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 w-8 p-0 rounded-lg bg-sky-500/10 text-sky-300 transition-colors hover:bg-sky-500/25 hover:text-sky-200"
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 w-8 p-0 rounded-lg bg-violet-500/10 text-violet-300 transition-colors hover:bg-violet-500/25 hover:text-violet-200"
                    ...
                    <Button
                      ...
                      size="sm"
                      className={cn(
                        "relative h-8 w-8 p-0 rounded-lg transition-colors",
                        userApproval?.status === 'changes_requested' || userApproval?.status === 'requested_changes'
                          ...
                          : "bg-amber-500/10 text-amber-300 hover:bg-amber-500/25 hover:text-amber-200",
                      )}
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        userApproval?.status === 'approved'
                          ...
                          : "bg-emerald-500/10 text-emerald-300 hover:bg-emerald-500/25 hover:text-emerald-200",
                      )}
                    ...
                    {(user?.role === 'admin' || user?.role === 'editor') && project && (
                      <>
                        <Button 
                          variant="ghost"
                          size="sm"
                          className="h-8 w-8 p-0 rounded-lg bg-teal-500/10 text-teal-300 transition-colors hover:bg-teal-500/25 hover:text-teal-200 disabled:opacity-40"
      ...
      {file && (
        ...
        >
          <Tabs defaultValue="comments" className="flex-1 min-h-0 flex flex-col">
            ...
            <TabsContent value="comments" className="flex-1 min-h-0 p-0 overflow-auto lg:overflow-hidden">
              <TimelineComments 
                fileId={file.id} 
                duration={duration} 
                currentTime={currentTime}
